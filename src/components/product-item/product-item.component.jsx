...
const ProductItem = ({ product, match, history }) => {
  ...
  return (
    <Grid
      onClick={() => history.push(`${match.url}/${product.id}`)}
        ...
        <CardActionArea>
          <div className={classes.details}>
            <CardContent className={classes.content}>
              ...
              {Object.getOwnPropertyNames(product.uniqueAttributes)
                .filter((property, index) => index < 5)
                .map((property) =>
                  property === '__typename' ||
                  product.uniqueAttributes[property] === null ||
                  product.uniqueAttributes[property] === '' ? null : (
                    <Grid container>
                      <Grid item xs={7}>
                        <Typography
