...
const NotificationPreview = ({role,requests}) => (
   <div>
    ...
    <Grid container style={{background:'#f6f6f6', margin:'30px'}} alignItem='center' justify='center'>
        <Typography style={{margin:'20px'}}color='secondary' variant ='h5'>You don't have any notifications</Typography>
        </Grid>
