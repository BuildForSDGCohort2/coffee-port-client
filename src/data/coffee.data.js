  ...
  Description: [
    {
      ...
      There are several heirloom varietals that grow specifically in this region, that interact well with the altitude,
       climate, and soil type to produce a very unique flavor profiles.
       Quality Harrar coffees are notable for a fruity characteristic and a creamy body. 
      The finest Harrar coffees have a distinct note of blueberry, though many other fruity and fruit-like 
      aromatic flavors can occur.
      One kind of differentiated coffee that comes out of the Harrar area is the “amber bean” or 
      “golden bean coffee.” The reference here is to the appearance of the milled, unroasted coffee, 
      which is yellowish/amber in color. However, it is important to realize that this color can come result
       from more than one process, and there is more than one flavor profile associated with amber bean coffee. `,
      `   
    ...
    in East Harrar.This is “naturally occurring” amber bean coffee, and often has an excellent, vibrant and rich blueberry flavor.`,
      `Because of the premium that amber bean Harrar coffee has demanded in the past, some producers
     have begun selecting out yellowish beans from larger lots of “regular” coffee, and using these
      hand-selected beans to create smaller “amber bean” lots. However, amber lots created this way do not 
      necessarily have a superior flavor, and can even have an inferior flavor. In fact, one of the ways amber 
      lots are created is using past-crop coffee that has turned yellow from age. Nevertheless, this coffee can 
      still fetch a premium because some foreign buyers simply see “amber coffee from Harrar.” The best way to
       avoid this kind of confusion, as always, is to obtain a sample and cup it for flavor.

    `,
      `East Harrar coffees tend to have the most distinct blueberry flavors, for which the region 
    is famous. However, in blind cupping, West Harrar coffees and even Bale and Arsi coffees can
     outscore East Harrar lots. Often West Harrar coffees have a thicker, smoother body, and a milder fruit flavor.
    `,
      `It is important to note that some growing areas that are geographically located in the West Harrar
     region are nevertheless classified as East Harrar coffees. This is because the coffees grown there 
     have the distinct East Harrar profile. This phenomenon is limited to the southeastern most communities
      of West Harrar, the ones that border along East Harrar, as one would expect.
    Harrar coffee is exported all over the world, but there is a particular demand for it in Saudi Arabia.
     This constant demand tends to keep the price for commercial grade Harrar coffee slightly higher than
      most other Ethiopian coffee regions.
          `,
      ],
      coffeeDesignationsList: [['Harrar A', 'East Harrar, plus the geographically western locations of Hirna, Gemechisa, Debesso, Messela, Gerawa, Gewgew, and Dire Dawa Zuria.'],
      ...
      Commercial grade coffees are given a grade between 3 and 9, and are designated geographically by the letters A, B, C, and D.`,
      ` 
      Remember, the letters do not represent grades, only geographical categories. The purchasing center for all Harrar coffees is the city of Dire Dawa  
...
`,
    ...
    {
      title: 'Sidama',
      coffeeDesignationsList: [['Sidama A', 'Borena, Benssa, Guji, Arbigona, Chire, Bona Zuria, and Arroressa [Hawassa]'],
      ...
      Varying soil types, micro climates, and especially the countless heirloom coffee tree varietals make for a kaleidoscope of different flavors. It is difficult to make any single description of Sidama coffees, without immediately 
      encountering another coffee that fits a completely different profile. The strength of Sidama lies in its variety.
      One feature of excellent Sidama coffee is often a profound complexity.`,
      ` This derives from the many different heirloom varietals. Many different farmers and pickers, each with a very small patch of land, often with their own unique 
      varietals, will pool their coffees at a cooperative. The resulting “blend” is a unique expression of the complexity of the horticulture in the surrounding area.
...
Hawassa is the main arrival center for Sidama, though some coffees are sold through the hub of Soddo.`, `Commercial grade washed coffees are given a grade of 3 through 9, and are divided into the  three geographical sub regions.
Designations for specialty grade washed coffees are Q1 and Q2 with geographical sub regions (some of which are different than they are for commercial grade coffees).`,
      `
Specialty grade washed coffees use the same letter groupings as specialty grade unwashed coffees, with the exception of the letter E grouping.
...
`,
    ...
    },
    {
      ...
      `
      Specialty grade coffee, both washed and unwashed, graded Q1 and Q2, 
      is given a designation by one of the four zones in Yirgacheffe. The A and B designations, once again, 
      refer to the presence or lack of classic Yirgacheffe flavor.
      All commercial grade coffee, washed and unwashed, graded 3 through 9, is simply called Yirgacheffe A or Yirgacheffe B. 
      Both categories include the four Yirgacheffe zones:
`],
      coffeeDesignationsList: [['Yirgachefe A', 'Yirgachefe, Wenago, Kochere, Gelena/Abaya'],
